...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pypika-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14282&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pypika-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pypika` can be installed with:

```
conda install pypika
```

It is possible to list all of the versions of `pypika` available on your platform with:
